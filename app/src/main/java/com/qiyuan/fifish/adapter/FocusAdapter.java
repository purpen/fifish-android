 ...
 */
public class FocusAdapter extends BaseAdapter<FocusBean.DataBean> implements View.OnClickListener {
...
//    private void doFocus(final FocusBean item, final View view) {
...
//    private void showFocusFansConfirmView(FocusBean item, String tips) {
...
//                final FocusBean item = (FocusBean) view.getTag();
...
//     * @param holder
//     */
//    private void dealOthersFoucsFansStyle(final FocusBean item, final ViewHolder holder) {
...
//    private void dealOthersFocus(final FocusBean item, final View view) {
