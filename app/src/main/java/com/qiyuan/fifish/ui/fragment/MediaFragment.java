...
public class MediaFragment extends BaseFragment implements TabLayout.OnTabSelectedListener,MediaInnerFragment.OnPhotoCountListener {
    ...
    TabLayout tabBar;
    @BindView(R.id.tv_choice_media)
    TextView mTvChoice;
    @BindView(R.id.image_import)
    ImageView mImageImport;
    @BindView(R.id.pager_media)
    ViewPager mPager;
    @BindView(R.id.layout_title)
    RelativeLayout mLayoutTitle;//白色背景标题栏
    @BindView(R.id.layout_blue)
    RelativeLayout mLayoutTop;//黑色背景标题栏
    @BindView(R.id.tv_show_pic_count_media_fragment)
    TextView mTvCount;
    @BindView(R.id.tv_cancel_media_fragment)
    TextView mTvCancel;
